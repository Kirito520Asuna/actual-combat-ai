package com.actual_combat.mp.abs.config;
...
@MapperScan(basePackages = {"com.actual_combat.**.dao","com.actual_combat.**.**.dao","com.actual_combat.**.mapper","com.actual_combat.**.**.mapper"})
