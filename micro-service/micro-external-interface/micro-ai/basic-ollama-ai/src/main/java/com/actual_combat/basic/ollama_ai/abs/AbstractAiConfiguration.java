package com.actual_combat.basic.ollama_ai.abs;
...
public interface AbstractAiConfiguration {
     ...
     * @return
     */
    default ChatClient buildDefaultChatClient(ChatClient model){
        ...
        return buildChatClient((ChatModel) model, system, advisors);
    }
