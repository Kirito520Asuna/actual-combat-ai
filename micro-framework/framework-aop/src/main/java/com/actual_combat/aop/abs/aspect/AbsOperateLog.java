...
import com.actual_combat.aop.abs.service.AbsOperateLogService;
import com.actual_combat.aop.all.log.SysLog;
import com.actual_combat.aop.pojo.OperateLogInfo;
import com.actual_combat.aop.pojo.ResultLog;
import com.actual_combat.aop.utils.date.AopDateUtils;
import com.actual_combat.aop.utils.servlet.AopServletUtils;
...
public interface AbsOperateLog extends AbsAop {
    ...
    @Override
    @Pointcut("@annotation(com.actual_combat.aop.all.log.SysLog)")
    default void Aop() {
